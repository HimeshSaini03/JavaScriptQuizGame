...
const Questions = [{
    ...
    a: [{ text: "Object-Based language", isCorrect: true  },
        { text: "Assembly-language", isCorrect: false },
        { text: "Object-Oriented language", isCorrect: false },
...
},
{
    ...
    a: [{ text: " #include [userdefined]", isCorrect: false },
        { text: "#include “userdefined”", isCorrect: true },
        { text: "#include &lt;userdefined.h&gt;", isCorrect: false },
